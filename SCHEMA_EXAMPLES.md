...
```json
{
    ...
    "@type": "VideoGame",
    "@id": "https://kloopik.com/catalog/rocket-racer/",
    "name": "Rocket Racer",
    ...
    "url": "https://kloopik.com/catalog/rocket-racer/",
    "image": [
    ...
    "potentialAction": {
        "@type": "PlayAction",
        "target": "https://kloopik.com/catalog/rocket-racer/"
    },
    "video": {
        "@type": "VideoObject",
...
```json
{
    ...
    "itemListElement": [
        ...
        },
        {
            ...
            "position": 4,
            "name": "Rocket Racer",
            "item": "https://kloopik.com/catalog/rocket-racer/",
...
```json
{
    "@context": "https://schema.org",
    "@type": "VideoGame",
    "@id": "https://kloopik.com/catalog/bubble-blast/",
    "name": "Bubble Blast",
    ...
    "url": "https://kloopik.com/catalog/bubble-blast/",
    "image": [
    ...
    "potentialAction": {
        "@type": "PlayAction",
        "target": "https://kloopik.com/catalog/bubble-blast/"
    }
}
```
...
```json
{
    "@context": "https://schema.org",
    "@type": "VideoGame",
    "@id": "https://kloopik.com/catalog/football-master/",
    ...
    "url": "https://kloopik.com/catalog/football-master/",
    "image": [
    ...
    "potentialAction": {
        "@type": "PlayAction",
        "target": "https://kloopik.com/catalog/football-master/"
    }
}
```
...
```json
{
    ...
    "url": "https://kloopik.com/catalog/{{GAME_SLUG}}/",
